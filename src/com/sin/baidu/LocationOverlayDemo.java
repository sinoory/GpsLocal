...
public class LocationOverlayDemo extends Activity {
	public static final String Tag="LocationOverlayDemo";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (app.mBMapManager == null) {
             ...
             */
            app.mBMapManager.init(new GpsApplication.MyGeneralListener());
        }
      ...
      //创建 弹出泡泡图层
        ...
        option.setAddrType("all"); //返回的定位结果包含地址信息， 如果不设置，location.getAddrStr();返回为null 
...
option.setPoiExtraInfo(true); //是否需要POI的电话和地址等详细信息
    ...
    public class MyLocationListenner implements BDLocationListener {
        ...
        public void onReceivePoi(BDLocation poiLocation) {
        	Log.d(Tag,"onReceivePoi poiLocation="+poiLocation);
            if (poiLocation == null){
                return ;
            }
        }
    ...
    //继承MyLocationOverlay重写dispatchTap实现点击处理
  	public class locationOverlay extends MyLocationOverlay{
  		...
  		protected boolean dispatchTap() {
  			...
  			//处理点击事件,弹出泡泡
  			showPopLocation(LocationOverlayDemo.this.mLocation);
...
class MyLocationMapView extends MapView{
    ...
    public boolean onTouchEvent(MotionEvent event){
		Log.d(LocationOverlayDemo.Tag,"MyLocationMapView onTouchEvent");
